...
public class Scene7_Bunny extends DefaultSceneDefinition {
    {
        ...
        try (ObjReader reader = new ObjReader(new FileInputStream("data/bunny.obj"))) {
        ...
        addObject(HalfSpace.horizontalPlane(-.35f), Material.gingham(1, Color.of(.75f, .5f, .5f)));
